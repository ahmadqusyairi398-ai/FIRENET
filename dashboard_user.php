...
<!-- Dashboard User Outdoor Custom CSS -->
...
<div class="main">
    ...
    <div class="header">
        <div class="header-left">
            <h2><i class="fas fa-fire-extinguisher"></i> Webiste Monitoring</h2>
    ...
    <div class="card">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px; flex-wrap: wrap; gap: 10px;">
            <h3 style="margin: 0; padding: 0; border: none;"><i class="fas fa-map-marker-alt"></i> Tempat Alat Monitoring</h3>
